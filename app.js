...
function navigate(page) {
  ...
  document.getElementById('pageTitle').textContent =
    {dashboard:'Dashboard',catalogo:'Catálogo',clientes:'Clientes',ventas:'Ventas',compras:'Compras',stock:'Stock',reportes:'Reportes',combos:'Combos'}[page];
  currentPage=page;
...
function renderPage(page) {
  ({dashboard:renderDashboard,catalogo:renderCatalogo,clientes:renderClientes,ventas:renderVentas,compras:renderCompras,stock:renderStock,reportes:renderReportes,combos:renderCombos})[page]?.();
}
